 ...
 */
export function decomposeColor(color: string | ColorType): ColorType {
  // Idempotent
 ...
 */
export function recomposeColor(color: ColorType) {
 ...
 * @returns {string} A CSS color string. Hex input values are returned as rgb
 */
export function darken(inputColor: string, coefficient: number) {
 ...
 * @returns {string} A CSS color string. Hex input values are returned as rgb
 */
export function lighten(inputColor: string, coefficient: number) {
  const color = decomposeColor(inputColor);
  coefficient = clamp(coefficient);
