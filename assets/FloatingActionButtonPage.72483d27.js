...
`;function O(){return i(C,{get name(){return n.name},examples:[p],docsName:"floating-action-button"})}r(O,"FloatingActionButtonPage");export{O as default};
