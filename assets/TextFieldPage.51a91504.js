...
`;function Wt(){return o(Ae,{get name(){return s.name},docsName:"text-fields",examples:[ce,{title:"Form props",component:pe},{title:"Uncontrolled vs. Controlled",component:fe}]})}i(Wt,"TextFieldPage");export{Wt as default};
