...
`;function b(){const[e,n]=R(!0);return o(r,{get checked(){return e()},onChange:(l,t)=>{n(t)},inputProps:{"aria-label":"controlled"}})}a(b,"ControlledCheckbox");b.code=`import Checkbox from "@suid/material/Checkbox";
...
`;function me(){return o(S,{get name(){return r.name},docsName:"checkboxes",examples:[C,{title:"Icon",component:v},{title:"Controlled",component:b}]})}a(me,"CheckboxPage");export{me as default};
