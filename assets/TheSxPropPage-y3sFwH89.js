var c=Object.defineProperty;var r=(e,t)=>c(e,"name",{value:t,configurable:!0});import{C as x}from"./ComponentInfo-CkarIG-0.js";import{t as i,F as s,h as n,B as a,ay as h,aW as o}from"./index-CjEeoCEC.js";import{T as u}from"./ThemeProvider-Dg6mAjeU.js";import"./Link-CKrTPHK1.js";import"./copyText-C93HcJfJ.js";import"./PaperCode-COQmQRMt.js";var f=i("<div>");function m(){return(()=>{var e=f();return s(e,n(a,{sx:{width:[100,200,300]},children:"This box has a responsive width."})),e})()}r(m,"BreakpointsAsArray");m.code=`import { Box } from "@suid/material";
...
`;var B=i("<div>");function d(){return(()=>{var e=B();return s(e,n(a,{sx:{width:{xs:100,sm:200,md:300,lg:400,xl:500}},children:"This box has a responsive width."})),e})()}r(d,"BreakpointsAsObject");d.code=`import { Box } from "@suid/material";
...
`;var b=i("<div>");function l(){return(()=>{var e=b();return s(e,n(a,{sx:{p:1,border:1,borderColor:r(t=>t.palette.primary.main,"borderColor")},children:"Border color with theme value."})),e})()}r(l,"ValueAsFunction");l.code=`import { Box } from "@suid/material";
