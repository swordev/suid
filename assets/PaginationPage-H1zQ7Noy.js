...
`;function G(){return e(v,{spacing:2,get children(){return[e(i,{count:10,variant:"outlined"}),e(i,{count:10,variant:"outlined",color:"primary"}),e(i,{count:10,variant:"outlined",color:"secondary"}),e(i,{count:10,variant:"outlined",disabled:!0})]}})}a(G,"PaginationOutlined");G.code=`import { Pagination, Stack } from "@suid/material";
...
`;function D(){return e(v,{spacing:2,get children(){return[e(i,{count:11,defaultPage:6,siblingCount:0}),e(i,{count:11,defaultPage:6})," ",e(i,{count:11,defaultPage:6,siblingCount:0,boundaryCount:2}),e(i,{count:11,defaultPage:6,boundaryCount:2})]}})}a(D,"PaginationRanges");D.code=`import { Pagination, Stack } from "@suid/material";
...
`;function E(){return e(v,{spacing:2,get children(){return[e(i,{count:10,shape:"rounded"}),e(i,{count:10,variant:"outlined",shape:"rounded"})]}})}a(E,"PaginationRounded");E.code=`import { Pagination, Stack } from "@suid/material";
...
`;function Ft(){return e(it,{get name(){return i.name},importInfo:["Pagination","PaginationItem"],examples:[W,G,E,j,H,U,D,V]})}a(Ft,"PaginationPage");export{Ft as default};
