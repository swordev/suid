...
`;function En(){return n(A,{get name(){return I.name},importInfo:["Menu","MenuItem","MenuList"],examples:[y,z,T,L,E]})}r(En,"MenuPage");export{En as default};
