...
`;function q(){return i(B,{get name(){return e.name},examples:[{component:h,title:"Basic FAB"},{title:"Size",component:p}],docsName:"floating-action-button"})}n(q,"FloatingActionButtonPage");export{q as default};
