...
`;const E=l('<svg><path d="M0 0h24v24H0z" fill="none"></svg>',!1,!0),P=l('<svg><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"></svg>',!1,!0),V=h(()=>[E(),P()],"Edit"),H=l('<svg><path d="M0 0h24v24H0z" fill="none"></svg>',!1,!0),L=l('<svg><path d="M12 2L4.5 20.29l.71.71L12 18l6.79 3 .71-.71z"></svg>',!1,!0),W=h(()=>[H(),L()],"Navigation");function F(){return e(m,{sx:{"& > :not(style)":{m:1}},get children(){return[e(n,{color:"primary","aria-label":"add",get children(){return e(s,{})}}),e(n,{color:"secondary","aria-label":"edit",get children(){return e(V,{})}}),e(n,{variant:"extended",get children(){return[e(W,{sx:{mr:1}}),"Navigate"]}}),e(n,{disabled:!0,"aria-label":"like",get children(){return e(N,{})}})]}})}t(F,"FloatingActionButtons");F.code=`import AddIcon from "@suid/icons-material/Add";
...
`;function Q(){return e(k,{get name(){return n.name},examples:[{component:F,title:"Basic FAB"},{title:"Size",component:f}],docsName:"floating-action-button"})}t(Q,"FloatingActionButtonPage");export{Q as default};
