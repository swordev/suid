...
`;const rn=p('<svg><path d="M0 0h24v24H0z" fill="none"></path></svg>',4,!0),en=p('<svg><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path></svg>',4,!0);var sn=k(()=>[rn.cloneNode(!0),en.cloneNode(!0)],"Add");const ln=p('<svg><path d="M0 0h24v24H0z" fill="none"></path></svg>',4,!0),cn=p('<svg><path d="M19 13H5v-2h14v2z"></path></svg>',4,!0);var gn=k(()=>[ln.cloneNode(!0),cn.cloneNode(!0)],"Remove");const A=p("<div></div>");function Z(){const[o,n]=M(1),[a,i]=M(!1),t=l(()=>{i(!a())},"handleBadgeVisibility");return s(K,{sx:{color:"action.active",display:"flex",flexDirection:"column","& > *":{marginBottom:2},"& .MuiBadge-root":{marginRight:4}},get children(){return[(()=>{const r=A.cloneNode(!0);return m(r,s(B,{color:"secondary",get badgeContent(){return o()},get children(){return s(y,{})}}),null),m(r,s(O,{"aria-label":"reduce",onClick:()=>{n(Math.max(o()-1,0))},get children(){return s(gn,{fontSize:"small"})}}),null),m(r,s(O,{"aria-label":"increase",onClick:()=>{n(o()+1)},get children(){return s(sn,{fontSize:"small"})}}),null),r})(),(()=>{const r=A.cloneNode(!0);return m(r,s(B,{color:"secondary",variant:"dot",get invisible(){return a()},get children(){return s(y,{})}}),null),m(r,s(O,{onClick:t,get children(){return["invisible=",_(()=>a()?"true":"false")]}}),null),r})()]}})}l(Z,"BadgeVisibility");Z.code=`import AddIcon from "@suid/icons-material/Add";
...
`;function bn(){return s(S,{get name(){return B.name},docsName:"badges",examples:[j,Z]})}l(bn,"BadgePage");export{bn as default};
