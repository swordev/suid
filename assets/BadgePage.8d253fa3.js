...
`;function j(){return s(b,{badgeContent:4,color:"primary",get children(){return s(x,{color:"action"})}})}l(j,"SimpleBadge");j.code=`import MailIcon from "@suid/icons-material/Mail";
import Badge from "@suid/material/Badge";
