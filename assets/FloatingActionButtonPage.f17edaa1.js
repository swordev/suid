...
`;function P(){return i(C,{get name(){return n.name},examples:[p],docsName:"floating-action-button"})}r(P,"FloatingActionButtonPage");export{P as default};
