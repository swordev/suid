...
`;function P(){return i(C,{get name(){return n.name},examples:[{component:g,title:"Basic FAB"}],docsName:"floating-action-button"})}r(P,"FloatingActionButtonPage");export{P as default};
