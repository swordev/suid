...
`;function v(){const[e,t]=H(!0);return o(r,{get checked(){return e()},onChange:(l,n)=>{t(n)},inputProps:{"aria-label":"controlled"}})}a(v,"ControlledCheckbox");v.code=`import Checkbox from "@suid/material/Checkbox";
...
`;function ue(){return o(V,{get name(){return r.name},docsName:"checkboxes",examples:[C,{title:"Icon",component:b},{title:"Controlled",component:v}]})}a(ue,"CheckboxPage");export{ue as default};
