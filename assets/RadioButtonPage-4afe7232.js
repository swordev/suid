...
`;function we(){return n(Z,{get name(){return i.name},docsName:"radio-button",examples:[{title:"Radio group",component:D},{title:"Controlled",component:T},{title:"Size",component:U},{title:"Color",component:w}]})}r(we,"ButtonPage");export{we as default};
