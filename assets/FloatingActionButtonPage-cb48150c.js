...
`;const L=s('<svg><path d="M0 0h24v24H0z" fill="none"></path></svg>',4,!0),P=s('<svg><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"></path></svg>',4,!0),V=h(()=>[L.cloneNode(!0),P.cloneNode(!0)],"Edit"),E=s('<svg><path d="M0 0h24v24H0z" fill="none"></path></svg>',4,!0),H=s('<svg><path d="M12 2L4.5 20.29l.71.71L12 18l6.79 3 .71-.71z"></path></svg>',4,!0),w=h(()=>[E.cloneNode(!0),H.cloneNode(!0)],"Navigation");function f(){return e(g,{sx:{"& > :not(style)":{m:1}},get children(){return[e(i,{color:"primary","aria-label":"add",get children(){return e(l,{})}}),e(i,{color:"secondary","aria-label":"edit",get children(){return e(V,{})}}),e(i,{variant:"extended",get children(){return[e(w,{sx:{mr:1}}),"Navigate"]}}),e(i,{disabled:!0,"aria-label":"like",get children(){return e(k,{})}})]}})}n(f,"FloatingActionButtons");f.code=`import AddIcon from "@suid/icons-material/Add";
...
`;function Z(){return e(R,{get name(){return i.name},examples:[{component:f,title:"Basic FAB"},{title:"Size",component:F}],docsName:"floating-action-button"})}n(Z,"FloatingActionButtonPage");export{Z as default};
