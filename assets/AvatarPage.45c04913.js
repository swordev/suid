...
`;function y(){return a(l,{direction:"row",spacing:2,get children(){return[a(s,{children:"H"}),a(s,{get sx(){return{bgcolor:S[500]}},children:"N"}),a(s,{get sx(){return{bgcolor:V[500]}},children:"OP"})]}})}n(y,"LetterAvatars");y.code=`import { Avatar, Stack } from "@suid/material";
...
`;function k(){return a(l,{direction:"row",spacing:2,get children(){return[a(s,{alt:"Remy Sharp",src:"https://mui.com/static/images/avatar/1.jpg",sx:{width:24,height:24}}),a(s,{alt:"Remy Sharp",src:"https://mui.com/static/images/avatar/1.jpg"}),a(s,{alt:"Remy Sharp",src:"https://mui.com/static/images/avatar/1.jpg",sx:{width:56,height:56}})]}})}n(k,"SizeImageAvatars");k.code=`import { Avatar, Stack } from "@suid/material";
...
`;function rt(){return a(F,{get name(){return s.name},examples:[b,y,{title:"Sizes",component:k},{title:"Variants",component:x}]})}n(rt,"AvatarPage");export{rt as default};
