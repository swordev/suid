...
`;function w(){return n(h,{get name(){return H.name},examples:[{component:l,title:"Color"}],docsName:"icons"})}t(w,"IconsPage");export{w as default};
