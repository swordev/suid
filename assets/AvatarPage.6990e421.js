...
`;function s(){return t(r,{direction:"row",spacing:2,get children(){return[t(a,{children:"H"}),t(a,{get sx(){return{bgcolor:i[500]}},children:"N"}),t(a,{get sx(){return{bgcolor:f[500]}},children:"OP"})]}})}n(s,"LetterAvatars");s.code=`import { Avatar, Stack } from "@suid/material";
...
`;function H(){return t(u,{get name(){return a.name},examples:[c,s,{title:"Sizes",component:o},{title:"Variants",component:m}]})}n(H,"AvatarPage");export{H as default};
